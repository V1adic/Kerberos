                        ...
                        case "/SetKey":
                            {
                                ...
                                var mes = BigInteger.Parse(data[1]);

                                var dataSertificat = Encoding.UTF8.GetString(Crypter.Magma_Decrypt(mes.ToByteArray())).Split(" ");
                                if (dataSertificat[0].Trim() != messages[0].Trim())
                                {
                                    Console.WriteLine(dataSertificat[0]);
                                    Console.WriteLine(messages[0]);
                                    Console.WriteLine("EVA!!!");
                                    break;
                                }

                                var timeStamp = long.Parse(messages[0].Trim()) + long.Parse(messages[1].Trim());
                                ...
                                await SendMessageAsync(Encoding.UTF8.GetBytes($"/Result {long.Parse(messages[0].Trim()) + 1}"));
                            }
                            break;
                    }
                }
