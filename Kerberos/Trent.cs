...
namespace Kerberos
{
    ...
    public class Trent : IDisposable
    {
        ...
        public static BigInteger ConvertStringToBigInteger(string input)
        {
        ...
        {
            // Получаем байты в двоичном представлении
            byte[] bytes = bigInteger.ToByteArray(isUnsigned: true);
