                        ...
                        case "/GetKey":
                            {
                                ...
                                long datas = long.Parse(messages[0]);

                                File.WriteAllText("Data/Temp", datas.ToString());
                                ...
                                var sertificat = new BigInteger(dat, isUnsigned: true);
...
#pragma warning restore CS8602
                        ...
                        case "/Result":
                            {
                                var datas = long.Parse(File.ReadAllText("Data/Temp"));
                                if (datas + 1 == long.Parse(services[1].Trim()))
                                {
                                ...
                                else
                                {
                                    ...
                                    Console.WriteLine(long.Parse(services[1].Trim()));
                                }
                            }
                            break;
                    }
